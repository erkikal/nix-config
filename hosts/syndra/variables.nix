{
  ...
  gitUsername = "Erki Kaljapulk";
  gitEmail = "109873035+erkikal@users.noreply.github.com";
  ...
  mimeDefaultApps = {
    ...
    #   # Web browser
    "x-scheme-handler/http" = ["vivaldi-stable.desktop"]; # or brave-browser.desktop, firefox.desktop
